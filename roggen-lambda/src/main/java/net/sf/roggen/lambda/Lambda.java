...
import net.sf.roggen.lambda.internal.Defaults;
...
public final class Lambda {
   ...
   *          the type to stub
   * @return a new stub
   * @see net.sf.roggen.lambda.LambdaFactory#$(java.lang.Class)
   */
   ...
   * 
   * @see net.sf.roggen.lambda.LambdaFactory#lambda(java.lang.Object)
   */
   ...
   * @see Lambda
   * @see net.sf.roggen.lambda.LambdaFactory#lambda(boolean)
   */
   ...
   * 
   * @see net.sf.roggen.lambda.LambdaFactory#lambda2(java.lang.Object)
   */
   ...
   * @return a new {@link Predicate}
   * @see Lambda
   * @see net.sf.roggen.lambda.LambdaFactory#lambda2(boolean)
   */
   ...
   * 
   * @see net.sf.roggen.lambda.LambdaFactory#lambda3(java.lang.Object)
   */
