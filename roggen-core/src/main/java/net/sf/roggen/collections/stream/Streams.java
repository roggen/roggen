...
import net.sf.roggen.collections.internal.iterator.IterateIterator;
import net.sf.roggen.collections.restrictions.Projection;
import net.sf.roggen.collections.restrictions.Repeatable;
import net.sf.roggen.collections.stream.internal.ArrayStream;
import net.sf.roggen.collections.stream.internal.CharSequenceStream;
import net.sf.roggen.collections.stream.internal.CollectionStream;
import net.sf.roggen.collections.stream.internal.DequeStream;
import net.sf.roggen.collections.stream.internal.EmptyStream;
import net.sf.roggen.collections.stream.internal.IterableStream;
...
import net.sf.roggen.collections.stream.internal.SingleStream;
import net.sf.roggen.collections.stream.internal.algorithms.DelayedRepatIterator;
import net.sf.roggen.collections.stream.internal.algorithms.RepeatIterator;
import net.sf.roggen.collections.stream.internal.algorithms.delayed.ConsStream;
import net.sf.roggen.collections.stream.internal.algorithms.delayed.DelayedSingleStream;
import net.sf.roggen.defs.Applicable;
import net.sf.roggen.defs.Thunk;
import net.sf.roggen.iterators.EnumerationIterator;
import net.sf.roggen.lang.internal.Add;
import net.sf.roggen.lang.predicate.Predicates;
import net.sf.roggen.lang.thunk.Thunks;
import net.sf.roggen.restrictions.Conditionally;
