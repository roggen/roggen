...
import net.sf.roggen.defs.partial.FirstAware;
import net.sf.roggen.defs.partial.FourthAware;
import net.sf.roggen.defs.partial.SecondAware;
import net.sf.roggen.defs.partial.ThirdAware;
...
import net.sf.roggen.defs.tuple.Tuple4;
