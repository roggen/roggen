...
import net.sf.roggen.check.internal.EmptyAwareTypes;
import net.sf.roggen.check.internal.SizeAwareTypes;
...
import net.sf.roggen.defs.type.EmptyAwareType;
