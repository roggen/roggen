...
import net.sf.roggen.lang.thunk.internal.NullThunk;
...
public abstract class RepetableStreamTheories extends StreamTheories {
  ...
  /**
   * Test method for
   * {@link net.sf.roggen.collections.stream.AbstractStream#filter(net.sf.roggen.defs.Evaluable)}
   * .
   * 
   * @param stream
   * @param predicate
  ...
  /**
   * Test method for
   * {@link net.sf.roggen.collections.stream.AbstractStream#find(net.sf.roggen.defs.Evaluable)}
   * .
   * 
   * @param stream
   */
  ...
  /**
   * Test method for
   * {@link net.sf.roggen.collections.stream.AbstractStream#findOrNull(net.sf.roggen.defs.Evaluable)}
   * .
   * 
   * @param stream
   * @param predicate
  ...
  /**
   * Test method for
   * {@link AbstractStream#map(net.sf.roggen.defs.Applicable)}
   * 
   * @param stream
   * @param function
   */
  ...
  /**
   * Test method for
   * {@link net.sf.roggen.collections.stream.AbstractStream#first()}.
   * 
   * @param stream
   */
  @Theory
  ...
  /**
   * Test method for
   * {@link net.sf.roggen.collections.stream.AbstractStream#second()}.
   */
  @Theory
  ...
  /**
   * Test method for
   * {@link net.sf.roggen.collections.stream.AbstractStream#third()}.
   * 
   * @param stream
   */
  @Theory
  ...
  /**
   * Test method for
   * {@link net.sf.roggen.collections.stream.AbstractStream#last()}.
   * 
   * @param stream
   */
  @Theory
  ...
  /**
   * Test method for
   * {@link net.sf.roggen.collections.stream.AbstractStream#get(int)}.
   * 
   * @param stream
   */
  @Theory
  ...
  /**
   * Test method for
   * {@link net.sf.roggen.collections.stream.AbstractStream#toSet()}.
   * 
   * @param stream
   */
  @Theory
  ...
  /**
   * Test method for
   * {@link net.sf.roggen.collections.stream.AbstractStream#toList()}.
   * 
   * @param stream
   */
  @Theory
