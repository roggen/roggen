...
import static net.sf.roggen.lang.Compare.lessThan;
import static net.sf.roggen.lang.tuple.Tuples._;
import static net.sf.roggen.numbers.NumberTypes.add;
import static net.sf.roggen.numbers.NumberTypes.bigInteger;
import static net.sf.roggen.numbers.NumberTypes.double_;
import static net.sf.roggen.numbers.NumberTypes.integer;
import static net.sf.roggen.numbers.Numbers.i;
import static net.sf.roggen.util.Strings.length;
...
public class AbstractStreamBasicTest {
  ...
  /**
   * Test for {@link Stream#flatMap(net.sf.roggen.defs.Applicable)}
   */
  @Test
  ...
  /**
   * Test for
   * {@link AbstractStream#groupOn(net.sf.roggen.defs.Applicable, Applicable2)}
   */
  @Test
  ...
  /**
   * Tests
   * {@link Stream#equivOn(net.sf.roggen.defs.Applicable, Iterable)}
   */
  @Test
