...
package net.sf.roggen.restrictions.instrument.maven;

import java.io.File;
import java.util.Collection;

import net.sf.roggen.instrument.config.InstrumenterConfigurer;
import net.sf.roggen.instrument.maven.InstrumentMojoSupport;
import net.sf.roggen.restrictions.instrument.RestrictionConfigurer;
