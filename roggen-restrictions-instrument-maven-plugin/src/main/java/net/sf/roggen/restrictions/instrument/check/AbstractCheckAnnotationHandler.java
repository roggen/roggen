...
public abstract class AbstractCheckAnnotationHandler<T extends Annotation> implements MethodAnnotationHandler<T>,
  ...
  protected static final String ENSURE_FULLY_QUALIFIED_NAME = "net.sf.roggen.check.Ensure.";
  protected static final String ASSERT_FULLY_QUALIFIED_NAME = "net.sf.roggen.check.Assert.";
