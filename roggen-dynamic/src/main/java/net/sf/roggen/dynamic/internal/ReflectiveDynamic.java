...
package net.sf.roggen.dynamic.internal;

import static net.sf.roggen.dynamic.internal.Methods.*;
...
import net.sf.roggen.dynamic.AbstractDynamic;
import net.sf.roggen.dynamic.Dynamic;
import net.sf.roggen.dynamic.Dynamics;
import net.sf.roggen.dynamic.MessageNotUnderstoodException;
import net.sf.roggen.dynamic.MethodEvaluationException;
